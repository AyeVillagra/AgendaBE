...
namespace apidemo.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        [HttpPost("authenticate")] // estoy creando una sesión
        ...
        {
           {
                ...
                if (user != null)
                {
                    ...
                    claimsForToken.Add(new Claim("role", user.Rol.ToString())); //vinculado al ContactController método delete (se hace de manera "casera" así - clase 2/11)
